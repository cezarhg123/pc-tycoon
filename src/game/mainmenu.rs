...
use crate::{gfx::Rect, math::vec2::vec2, DEFAULT_WINDOW_WIDTH, DEFAULT_WINDOW_HEIGHT};
...
impl MainMenu {
    pub fn new(display: &Display) -> MainMenu {
        let mut background = Rect::new(vec2(640.0, 360.0), vec2(DEFAULT_WINDOW_WIDTH as f32, DEFAULT_WINDOW_HEIGHT as f32), display);
