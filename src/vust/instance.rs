// if you code that doesnt use the "get_vkobject" and "set_vkobject" functions, 
// its because i copy pasted the code from https://github.com/cezarhg123/rustcraft/blob/master/src/engine/mod.rs

use std::{ffi::{CString, CStr}, ptr::null};
use ash::vk;
use winapi::um::libloaderapi::GetModuleHandleW;
use super::{DEBUG, vulkan_debug_callback, vertex::Vertex};
...
unsafe fn create_instance(glfw: &glfw::Glfw) {
    ...
    let c_name = CString::new("Assembly Gate").unwrap();
...
unsafe fn create_graphics_pipeline() {
    ...
    let sampler_descriptor_binding = vk::DescriptorSetLayoutBinding::builder()
        .binding(0)
        .descriptor_count(1)
    ...
    // gotta do it like this because fuck rust
